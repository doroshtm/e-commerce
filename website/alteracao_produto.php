...
<html lang="pt-BR">
    ...
    <body>
        <div id='pai'>
            <form name='alterarProduto' method='post' action='./alteracao_produto.php?id=<?php echo $_GET['id'] ?>' id='formLogin'>
            <div id="logo-login">
                    <img src="imagens/Emblema_Mascotero.svg" alt="Logo Mascotero">
                    Mascotero
                </div>                
                <img src='./imagens/produtos/<?php echo $result['imagem'] ?>' alt='Imagem atual do produto' width=200px>
                ...
                <div class="label-input-login">
                    ...
                    <input type='file' id='imagem' name='imagem' placeholder='Imagem do produto' accept='image/*' value='<?php echo $result['imagem'] ?>'><br>
                </div>
                <div class="label-input-login">
